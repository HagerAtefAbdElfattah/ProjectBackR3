    ...
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="" method="post" name="LoginForm">
              <h1>Login Form</h1>
              <div>
                <input type="text" class="form-control" placeholder="Username" required="" name="logUsername" />
              </div>
              <div>
                <input type="password" class="form-control" placeholder="Password" required="" name="logPassword" />
              </div>
              <div>
              <button class="btn btn-default submit" name="loginSubmit" type="submit">Log in</button>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form action="" method="post" name="RegisteForm">
              ...
              <div>
                <button class="btn btn-default submit" name="registerSubmit" type="submit">Submit</button>
              </div>
